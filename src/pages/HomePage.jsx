...
import AnimeCarousel from "../components/Carousel.jsx";
...
const HomePage = () => {
    ...
    const [carouselAnime, setCarouselAnime] = useState([]);
    ...
    const fetchCarouselData = async () => {
        try {
            const data = await getCarouselAnime();
            setCarouselAnime(data);
        } catch (error) {
    ...
    return (
        <>
            <MyNavbar />
            <AnimeCarousel anime={carouselAnime} />
                ...
                {loading ? (
                    ...
                    <>
                        <div className="container mt-4" style={{ padding: 0 }}>
                            <h2 style={{ color: '#FFFFFF', margin: '5px' }}>Ongoing Anime</h2>
